$(document).ready(function () {
    ...
    $('#add').click(function () {
        ...
        if (isAllValid) {
            ...
            // for($i=0; $i<100; $i++)
            // {
                // $('#Item_ID',$newRow).attr('name', 'item_id[$i]');
                // $('#Stock_Location_ID',$newRow).attr('name', 'stock_location_id[$i]');
                // $('#quantity',$newRow).attr('name', 'quantity[$i]');
                // $('#price',$newRow).attr('name', 'purchase_price[$i]');
                // $('#vat',$newRow).attr('name', 'vat[$i]');
            // }
